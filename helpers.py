...
def evaluate_results(consolidated_dict, gt_dict, full_results=None):
    ...
    print(f"Top-1 Accuracy: {correct_all}/{len(y_true)} = {100 * correct_all / len(y_true):.2f}%")
    ...
    print(f"Top-1 Accuracy: {correct_leg}/{len(pairs_leg)} = {100 * correct_leg / len(pairs_leg):.2f}%")
    print("Precision / Recall / F1-score:")
